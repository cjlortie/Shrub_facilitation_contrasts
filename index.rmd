...
output:
  ...
  pdf_document:
    toc: yes
---
###A test of foundation plant facilitation specificity.
The hypothesis tested is that foundation shrub positive effects are species specific.
*Ephedra californica* effects are contrasted to those of *Larrea tridentata*.  
...
###Data and meta-data
Panoche sites = 1.1 is plateau, 1.2 is south, 1.3 is north.  
Mojave sites = a total of five sites with each on Kelbaker Road corresponding to increasing elevations of 313, 515, 737,951, & 1128.   

``` {r, data and wrangling, echo=TRUE, warning=FALSE, message=FALSE}
#data wrangling####
#primary data
...
###Data viz Rii
``` {r fig.width = 24, fig.height = 11, echo=FALSE}
##x-axis locations
xax <- seq(1,8, by=c(1))
...
###Data viz ordinations
```{r fig.width=9, fig.height=9, warning=FALSE, echo=FALSE}
# 2x2 plot
par(mfrow=c(2,2))

## Hellinger transformation --> Legendre and Gallagher 2001
pan.2015.trans <-decostand(pan.2015[,11:40], method="hellinger") #select only species columns
